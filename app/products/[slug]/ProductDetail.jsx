    ...
    <div className="min-h-screen bg-[#111827] pb-[100px]">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-5 max-md:px-4 !pt-5 pb-6 px-5">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,900px)_minmax(0,380px)] gap-10 max-w-[1400px] mx-auto items-start justify-center">
          ...
          {/* Right Column */}
          <div className="hidden lg:flex flex-col gap-6 sticky top-[85px] self-start">
            {/* Price & Title */}
            ...
            <div className="p-5 bg-[#1f2937] border border-[#374151] rounded-xl">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                {product?.whatsapp_number && (
                  <button
                    className="flex items-center justify-center gap-2.5 py-3 px-4 rounded-[10px] text-[15px] font-semibold cursor-pointer transition-all border-0 bg-[#25D366] text-white hover:bg-[#128C7E] hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(37,211,102,0.3)]"
      ...
      {isMobile === true && (product?.whatsapp_number || product?.phone_number) && (
        <div
          ...
          style={{
            gridTemplateColumns: product?.phone_number && product?.whatsapp_number ? '1fr 2fr' : '1fr'
          }}
        >
          {product?.phone_number && (
            <button
