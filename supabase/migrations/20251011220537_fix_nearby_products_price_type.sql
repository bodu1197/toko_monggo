-- Fix nearby_products function return type for price column
-- The 'price' column in products table is integer, not bigint
...
RETURNS TABLE(
  ...
  price integer,  -- Changed from 'bigint' to 'integer'
  distance_km numeric
)
LANGUAGE plpgsql
SECURITY DEFINER
