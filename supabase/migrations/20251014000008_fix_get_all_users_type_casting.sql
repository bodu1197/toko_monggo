-- Fix get_all_users_with_email RPC function - add explicit type casting
...
BEGIN
  ...
  SELECT
    p.id,
    u.email::TEXT,
    p.full_name::TEXT,  -- Explicit cast to TEXT
    p.username::TEXT,   -- Explicit cast to TEXT
    p.avatar_url::TEXT, -- Explicit cast to TEXT
    p.bio::TEXT,        -- Explicit cast to TEXT
    p.role::TEXT,       -- Explicit cast to TEXT
    p.created_at,
